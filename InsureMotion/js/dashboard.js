              ...
              datasets: [
                {
                  ...
                  borderWidth: 1,
                  fill: 'origin',
                  data: [1000, 40, 15, 35, 25, 50, 30, 20]
                },
                {
                  label: "South Zone",
                  borderColor: '#e9eaee',
...
var randomNum43 = Math.floor((Math.random() * 45)+15);
      var trafficChartData = {
        datasets: [{
          data: [randomNum43, 100-randomNum43],
          backgroundColor: [
            gradientStrokeBlue,
            gradientStrokeGreen,
            gradientStrokeRed
      ...
      var trafficChartOptions = {
        ...
        legendCallback: function(chart) {
          var text = [];
          text.push('<ul>');
          for (var i = 0; i+1 < trafficChartData.datasets[0].data.length; i++) {
              text.push('<li><span class="legend-dots" style="background:' +
